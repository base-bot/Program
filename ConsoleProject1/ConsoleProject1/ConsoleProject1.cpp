...
int main()
{
	...
	double module_angle, frcition_coefficient;
	cout << "\n\n Type in please additional information necessary for the sytem installation:" << endl;
	cout << "System Inlicnation in degrees = "; cin >> module_angle;
	cout << "Friction Coefficient for the surfacebetween the system and Roof = "; cin >> frcition_coefficient; //This should be then updated into a value that is either given out or standard value between different materials...based on type of roof's surface
